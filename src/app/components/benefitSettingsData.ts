...
export const benefitsSettingsData: Record<string, BenefitSettingsEntry> = {
  'mittagessen': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei bis 7,67 €/Arbeitstag (§8 Abs. 2 EStG)',
      sv: 'SV-frei',
    },
  },
  'internet': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei bis 50 €/Monat (§3 Nr. 45 EStG)',
      sv: 'SV-frei',
    },
  },
  'kindergarten': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei (§3 Nr. 33 EStG) — kein Höchstbetrag',
      sv: 'SV-frei',
    },
  },
  'commuting': {
    ...
    taxInfo: {
      steuer: '15 % Pauschalsteuer + Soli + Kirche (§40 Abs. 2 EStG)',
      sv: 'SV-frei',
    },
  },
  'erholung': {
    ...
    taxInfo: {
      steuer: '25 % Pauschalsteuer + Soli + Kirche (§40 Abs. 2 EStG)',
      sv: 'SV-frei',
    },
  },
  'sachbezug': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei bis 50 €/Monat (§8 Abs. 2 EStG)',
      sv: 'SV-frei',
    },
  },
  'danke-bonus': {
  ...
  'geburtstag': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei bis 60 €/Anlass (§8 Abs. 2 EStG)',
      sv: 'SV-frei',
    },
  },
  'oepnv': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei (§3 Nr. 15 EStG)',
      sv: 'SV-frei',
    },
  },
  'bkv': {
  ...
  'bav': {
    ...
    taxInfo: {
      steuer: 'Steuerfrei bis 4 % BBG (§3 Nr. 63 EStG)',
      sv: 'SV-frei bis 4 % BBG',
    },
  },
};
