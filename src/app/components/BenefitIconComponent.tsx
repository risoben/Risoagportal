...
const benefitConfig: Record<string, { svgPath: string; color: string; fallbackEmoji?: string }> = {
  ...
  'Geburtstag': { svgPath: '/assets/benefit-icons/Geburtstag.svg', color: '#E91E63' },
  'Geburtstagsgutschein / Jubiläum': { svgPath: '/assets/benefit-icons/Geburtstag.svg', color: '#E91E63' },
