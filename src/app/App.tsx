        ...
        {currentView === 'help-center' ? (
          ...
          <>
            ...
            <div className="flex-1 overflow-auto bg-[#F9FAFB]">
              ...
              {currentView === 'benefits-edit' && ['mittagessen', 'internet', 'commuting', 'oepnv', 'sachbezug', 'kindergarten'].includes(navigationData.benefitId) && <BenefitSettings benefitId={navigationData.benefitId} />}
